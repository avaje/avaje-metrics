...
public class Histogram {
  ...
  enum SampleType {
    /**
     * Uses a uniform sample of 1028 elements, which offers a 99.9% confidence
     * level with a 5% margin of error assuming a normal distribution.
     */
    UNIFORM {
      @Override
     ...
     * distribution, and an alpha factor of 0.015, which heavily biases the
   ...
   * 
   * @param sample
   *          the sample to create a histogram from
   */
